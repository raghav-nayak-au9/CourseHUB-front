...
class ViewLecture extends Component {
    ...
    customPlayer = (video, url) => {
        ...
        const updateTime = function(x) {
            video[0].pause();
            const maxduration = video[0].duration;
            let percentage = x * 100 / maxduration;
            $('.timeBar').css('width',percentage+'%');
            video[0].currentTime = maxduration * percentage / 100;
        };
        ...
        const fullScreenEnabled = !!(document.fullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || document.webkitSupportsFullscreen || document.webkitFullscreenEnabled || video.webkitRequestFullScreen);
            ...
            <div>
                ...
                <div id="video-controls" className="control text-white">
                    ...
                    <div className="downControl">
                        ...
                        <a href="#" id="0_5" className="speedRate">x0.5</a>
                        <a href="#" id="1_0" className="speedRate">x1.0</a>
                        <a href="#" id="2_0" className="speedRate">x2.0</a>
    ...
    renderVideo = () => {
        ...
        <ReactPlayer ref={player => { this.player = player }}
                     width='100vw' height='100vh' url={`${hostUrl}/video/lecture-${url}.mp4`} playing={true} controls={false} fileConfig={{attributes: {preload: true}}}/>
                {this.renderControl()}
                </div>
            </div>
        );
